...
bool NES::apuCyclesLeft() { return apu->getCyclesLeft(); }

void NES::apuCycle() { apu->cycle(); }
bool NES::ppuCyclesLeft() { return ppu->getCyclesLeft(); }

std::vector<std::vector<RGB>> NES::getFrame() { return ppu->getFrame(); }
...
// Check reset
// Do CPU and PPU cycle together? Can the CPU and the PPU both do something in
// the same cycle