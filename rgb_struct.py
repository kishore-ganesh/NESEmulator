...
pallete = "84  84  84    0  30 116    8  16 144   48   0 136   68   0 100   92   0  48   84   4   0   60  24   0   32  42   0    8  58   0    0  64   0    0  60   0    0  50  60    0   0   0 \
...
pallete = list(filter(lambda x: x!="", pallete))
print(pallete)
count = 0
for num in pallete:
    if count==0:
